          ...
          <div className="col-md-8">
            <div className="card-body h-100 col-md-8 col-12 d-flex flex-column justify-content-around">
              <div>
                ...
                <h5 className="card-title">Quantité Disponible: {qteDispo}</h5>
              </div>
              <select
              ...
              >
                ...
                {produit?.caracteristiques
                  .sort(
                    (a, b) =>
                      a.capacite.match(/\d+/g)[0] - b.capacite.match(/\d+/g)[0]
                  )
                  .map((car) => {
                    return (
                      <option key={car.idCaracteristique} value={car.capacite}>
                        {car.capacite}
                      </option>
                    );
                  })}
              ...
              <div>
                ...
                <button
                  ...
                  disabled={qteAchat > qteDispo || qteAchat < 1 || isNaN(prix)}
                  onClick={() => addToPanier()}
                >
                  Acheter
                </button>
